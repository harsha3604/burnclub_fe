      ...
      <section className={styles.header}>
        <div className={`container ${styles.headerInner}`}>
          ...
          <p className={styles.lead}>
            Questions about membership, class schedules, or an upcoming
            event? Reach out through any of the channels below — we tend to
            reply fastest on Instagram and WhatsApp.
          </p>
        </div>
